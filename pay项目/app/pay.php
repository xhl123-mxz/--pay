...
$_str = '<li>什么都没有~~</li>';
      ...
      foreach ($rs as $v){
            	  	...
            	  	$_str .='<li><h2><a class="layui-badge">'.$v['user'].'</a> <a href="">付款'.$v['oje'].'元</a></h2><div class="fly-list-info"><a href="" link><cite>'.$v['otime'].'</cite> </a><span>'.($v['ispay']=="1"?'[已支付]':'[待支付]').'</span> <span class="fly-list-nums"><span class="fly-list-kiss layui-hide-xs" title="施舍单号">'.$v['oid'].'</span></span></div><div class="fly-list-badge"><span class="layui-badge '.($v['ispay']=="1"?'layui-bg-red':'layui-bg-blue').'">'.($v['ispay']=="1"?'已支付':'未支付').'</span></div></li>';
         }
